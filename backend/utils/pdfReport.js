...
function header(doc, title, subtitle) {
  ...
  doc.fillColor('#ffffff').fontSize(18).font('Helvetica-Bold').text('U-Trust', 40, 25);
...
function buildScanReport(scanResult) {
  return new Promise((resolve, reject) => {
    ...
    doc.fontSize(8).fillColor(COLORS.muted).text(
      'Report generated by U-Trust - Heuristic Multi-Layer Analysis Platform',
      40,
      doc.page.height - 50,
...
function buildSecurityReport(status) {
  return new Promise((resolve, reject) => {
    ...
    /* ── Footer ── */
    doc.fontSize(8).fillColor(COLORS.muted).text(
      'Report generated by U-Trust - Unified Threat Management Platform',
      40,
      doc.page.height - 50,
      { align: 'center', width: doc.page.width - 80 },
    );
